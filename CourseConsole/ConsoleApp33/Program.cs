            ...
            START:
                ...
                GRADE:
                    ...
                    case 5:
                        ...
                        Helper.Print("Search student: ", ConsoleColor.Green);
                        ...
                        foreach (var item in course.groups)
                        {
                            foreach (var item5 in item.students)
                            {
                                ...
                                {
                                    Helper.Print($"{item5.Id}  {item5.Name} {item5.Surname}", ConsoleColor.Yellow);
                                }
                            }
                        }
                        break;
                        ...
                        foreach (var item in course.groups)
                        {
                            foreach (var elem in item.students)
                            {
                                ...
                                GRADE2:
                                    ...
                                    Helper.Print("Enter new grade ", ConsoleColor.Yellow);
                                    string strGrade = Console.ReadLine();
